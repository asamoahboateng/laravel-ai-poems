            ...
            <div class="flex h-full flex-col">
                ...
                <nav class="flex-1 space-y-1 px-3 py-4">
                    ...
                    <a href="{{ route('chat') }}" wire:navigate
                       class="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium {{ request()->routeIs('chat') ? 'bg-indigo-800 text-white' : 'text-indigo-200 hover:bg-indigo-800 hover:text-white' }}">
